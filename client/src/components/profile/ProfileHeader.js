              ...
              <p>
                ...
                {isEmpty(profile.social && profile.social.twitter) ? null : (
                  <a
                    className="text-white p-2"
                    href={
                      profile.social.twitter.substring(0, 4) === "http"
                ...
                {isEmpty(profile.social && profile.social.facebook) ? null : (
                  <a
                    className="text-white p-2"
                    href={
                      profile.social.facebook.substring(0, 4) === "http"
                ...
                {isEmpty(profile.social && profile.social.linkedin) ? null : (
                  <a
                    className="text-white p-2"
                    href={
                      profile.social.linkedin.substring(0, 4) === "http"
                ...
                {isEmpty(profile.social && profile.social.youtube) ? null : (
                  <a
                    className="text-white p-2"
                    href={
                      profile.social.youtube.substring(0, 4) === "http"
                ...
                {isEmpty(profile.social && profile.social.instagram) ? null : (
                  <a
                    className="text-white p-2"
                    href={
                      profile.social.instagram.substring(0, 4) === "http"
